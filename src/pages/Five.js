...
export default function One() {
  ...
  return (
    <Box sx={{ flexGrow: 1, width: "100%", minHeight: "auto" }}>
      <ReactPlayer style={{ position: "fixed", zIndex: "-10", left: "49%", height: "115vh", overflow: "hidden" }} url="/static/video/3.mp4" playing loop muted width="51%" height="100%" />

      {/* <ReactPlayer style={{ position: "absolute", zIndex: "-10" }} url="/static/video/3.mp4" playing loop muted width="100%" height="100%" /> */}
      <Grid container spacing={2} style={{ height: "100%" }}>
        <Grid item xs={6} style={{ backgroundColor: "#232323" }}>
          ...
          <Grid justifyContent="center" style={{ display: "grid" }} item xs={12}>
            <img alt="prop" src="static/image/five-2.png" ></img>
          </Grid><br />
          ...
          <Grid justifyContent="center" style={{ display: "grid" }} item xs={12}>
            <Typography style={{ color: "white", fontSize: "25px", fontWeight: "bolder", direction: "rtl" }}>יצירת מגורים מעוררת השראה בפרוייקט פורטרט</Typography>
          </Grid>
          <Grid justifyContent="center" style={{ display: "flex" }} item xs={12}>
            <Typography style={{ color: "#c8c8c8", fontSize: "25px", width: "80%", padding: "1% 10%", textAlign: "center", direction: "rtl" }}>חברת רוטשטיין יוצרת עבורכם איכות חיים חדשה בשכונה הוותיקה והמבוקשת נווה רסקו - רמת השרון. בואו להתרשם מפרויקט בוטיק חדש ויפהפה ובו דירות גדולות במיוחד עם מרפסות מרווחות, פטיו שטוף שמש מרהיב ותכנון אדריכלי יוצא דופן.
            </Typography>
          </Grid>
          <Grid justifyContent="center" style={{ display: "grid" }} item xs={12}>
