...
export default function One() {
  ...
  return (
    <Box sx={{ flexGrow: 1, width: "100%", minHeight: "auto" }}>
      <ReactPlayer style={{ position: "fixed", zIndex: "-10", width: "inherit", height: "auto" }} url="/static/video/1.mp4" playing loop muted width="inherit" height="100%" />
      ...
      <Grid container spacing={2} style={{ height: "100%" }}>
        <Grid item xs={6} style={{ backgroundColor: "#232323" }}>
          ...
          <Grid justifyContent="center" style={{ display: "grid" }} item xs={12}>
            <img alt="prop" src="static/image/four-1.png" ></img>
          </Grid><br />
          <Grid justifyContent="center" style={{ padding: "0% 10%" }} item xs={12}>
            ...
            <Grid justifyContent="center" style={{ display: "flex" }} item xs={12}>
              <Typography style={{ fontSize: "25px", width: "80%", padding: "1% 10%", textAlign: "center", direction: "rtl", fontWeight: "bolder", color: "#eb008b" }}>תנאי מימון 20/80 + פטור משכ”ט עו”ד + פטור לשנה מהמדד + הטבה בשינויי דיירים!</Typography>
            </Grid>
            <hr style={{ borderColor: "#eb008b" }}></hr>
          </Grid>
          <Grid justifyContent="center" style={{ display: "grid" }} item xs={12}>
            <Typography style={{ color: "white", fontSize: "25px", fontWeight: "bolder", direction: "rtl" }}>בואו לחיות בין תל אביב לים - Blue & The City</Typography>
          </Grid>
          <Grid justifyContent="center" style={{ display: "flex" }} item xs={12}>
            <Typography style={{ color: "#c8c8c8", fontSize: "25px", width: "80%", padding: "1% 10%", textAlign: "center", direction: "rtl" }}>מול חוף הסלע היפהפה של בת – ים ואופק כחול אינסופי, רוטשטיין גאה לבנות את Blue &The City. מגדל יוקרה עם כל הפינוקים, עם נוף פתוח לים מרוב הדירות ועם גישה מהירה ונוחה לכל מה שאתם אוהבים בתל אביב, מתחנת הרכבת הקלה שבסמוך.    </Typography>
          </Grid>
          <Grid justifyContent="center" style={{ display: "grid" }} item xs={12}>
            <Typography style={{ color: "white", fontSize: "25px", fontWeight: "bolder", direction: "rtl" }}>אל תיקחו את הזמן, קחו החלטה.</Typography>
          </Grid>
          <Grid justifyContent="center" style={{ display: "flex" }} item xs={12}>
            <Typography style={{ color: "#c8c8c8", fontSize: "25px", width: "80%", padding: "1% 10%", textAlign: "center", direction: "rtl" }}>4-5 חד׳ החל מ-</Typography>
          </Grid>
          <Grid justifyContent="center" style={{ display: "flex" }} item xs={12}>
            <Typography style={{ fontSize: "40px", fontWeight: "bolder", width: "80%", paddingTop: "0px", textAlign: "center", color: "#eb008b", direction: "rtl" }}>₪2,770,000</Typography>
          </Grid>
          <Grid justifyContent="center" style={{ padding: "0% 10%" }} item xs={12}>
