    ...
    <Box sx={{ flexGrow: 1, width: "100%", minHeight: "auto" }}>
      ...
      <Grid container spacing={2} style={{ height: "100%" }}>
        <Grid item xs={6} style={{ backgroundColor: "#232323" }}>
          ...
          <Grid justifyContent="center" style={{ display: "grid" }} item xs={12}>
            <Typography style={{ color: "white", fontSize: "25px", fontWeight: "bolder", direction: "rtl" }}>הדור החדש של מתחמי המגורים - רוטשטיין VALLEY</Typography>
          </Grid>
          <Grid justifyContent="center" style={{ display: "flex" }} item xs={12}>
            <Typography style={{ color: "#c8c8c8", fontSize: "25px", width: "80%", padding: "1% 10%", textAlign: "center", direction: "rtl" }}>רוטשטיין VALLEY שכונת החותרים הוא ההזדמנות שלכם לחיות בין הכחול של הים לירוק של הכרמל. חוויית מגורים מתקדמת ב - 3 בנייני בוטיק חדשים, בלב השכונה, הפונים למדרחוב ולגינה פסטורלית.
              !</Typography>
          </Grid>
          <Grid justifyContent="center" style={{ display: "grid" }} item xs={12}>
