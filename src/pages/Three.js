      ...
      <Grid container spacing={2} style={{ height: "100%" }}>
        <Grid item xs={6} style={{ backgroundColor: "#232323" }}>
          ...
          <Grid justifyContent="center" style={{ display: "grid" }} item xs={12}>
            <img alt="prop" src="static/image/three-1.png" ></img>
          </Grid><br />
          <Grid justifyContent="center" style={{ padding: "0% 10%" }} item xs={12}>
            ...
            <Grid justifyContent="center" style={{ display: "flex" }} item xs={12}>
              <Typography style={{ color: "#c8c8c8", fontSize: "25px", width: "80%", padding: "1% 10%", textAlign: "center", direction: "rtl", display: "contents", fontWeight: "bolder", color: "#21bf73" }}>תנאי מימון 20/80 + פטור מהמדד לשנה + פטור משכ”ט עו”ד</Typography>
            </Grid>
            <hr style={{ borderColor: "#21bf73" }}></hr>
          </Grid>
          <Grid justifyContent="center" style={{ display: "grid" }} item xs={12}>
