        ...
        <Grid item xs={6} style={{ backgroundColor: "#232323" }}>
          ...
          <Grid className="grid_header" item xs={12}>
            ...
            <Grid className="grid_header_1" item xs={12}>
              <p className="grid_header1" style={{ color: "#21bf73" }}>תנאי מימון 20/80 + פטור מהמדד לשנה + פטור משכ”ט עו”ד</p>
            </Grid>
            <hr style={{ borderColor: "#21bf73" }}></hr>
          </Grid>
          <Grid className="grid_title" item xs={12}>
            <p className="text_header">קלאסיקה תל אביבית - כיכר המדינה </p>
          </Grid>
          <Grid className="grid_header_1" item xs={12}>
            <p className="text_body">אתם חיים את תל אביב. עובדים בה, מבלים, מתרגשים מהקולינריה, מהתרבות המגוונת, מהמרקם האנושי הייחודי… לא הגיע הזמן שתגורו איפה שהכל קורה? פרויקט שרת 38 בסמוך לכיכר המדינה הוא ההזדמנות שלכם לאיכות חיים נדירה באחד הרחובות השקטים והירוקים בעיר. </p>
          </Grid>
          <Grid className="grid_title" item xs={12}>
            <p className="text_header"> אל תיקחו את הזמן, קחו החלטה. מס’ הדירות מוגבל! </p>
          </Grid>
          <Grid className="grid_header" item xs={12}>
            <p className="bottom_text_1">דירת גן 3 חד' החל מ-</p>
            <p className="bottom_text_2" style={{ color: "#21bf73" }} >₪5,965,000</p>
          </Grid>
